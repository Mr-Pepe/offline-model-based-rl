...
from offline_mbrl.utils.mazes import (
    ANTMAZE_ANT_RADIUS, ANTMAZE_MEDIUM_MAX, ANTMAZE_MEDIUM_MIN,
    ANTMAZE_MEDIUM_WALLS_WITHOUT_OUTSIDE,
    ANTMAZE_MEDIUM_WALLS_WITHOUT_OUTSIDE_CUDA, ANTMAZE_UMAZE_MAX,
    ANTMAZE_UMAZE_MIN, ANTMAZE_UMAZE_WALLS_WITHOUT_OUTSIDE,
    ANTMAZE_UMAZE_WALLS_WITHOUT_OUTSIDE_CUDA, MAZE2D_POINT_RADIUS,
    MAZE2D_UMAZE_WALLS)
