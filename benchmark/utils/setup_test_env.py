...
def setup_test_env(env):
    if env.spec.id == 'antmaze-medium-diverse-v0':
        start_state = ANTMAZE_MEDIUM_DIVERSE_START_STATES[np.random.choice(
            len(ANTMAZE_MEDIUM_DIVERSE_START_STATES), 1)[0]]
        o = env.reset()
...
ANTMAZE_MEDIUM_DIVERSE_START_STATES = [(0, 0),
                                       (4, 4),
                                       (4, 8),
                                       (8, 8),
                                       (12, 8),
...
ANTMAZE_UMAZE_START_STATES = [(0, 0),
                              (4, 0),
                              (8, 0),
                              (8, 4),
                              (8, 8),
