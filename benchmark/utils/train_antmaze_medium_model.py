...
if __name__ == '__main__':
    ...
    if args.augment:
        ...
        buffer = torch.load(
            '/home/felipe/Projects/thesis-code/data/datasets/antmaze_medium_augmented.p')
        obs_dim = env.observation_space.shape[0]
        act_dim = env.action_space.shape[0]
        save_path = '/home/felipe/Projects/thesis-code/data/models/antmaze_medium/augmented_model.pt'
    else:
        print("Load non-augmented dataset")
        buffer, obs_dim, act_dim = load_dataset_from_env(env,
                                                         buffer_device=device)
        save_path = '/home/felipe/Projects/thesis-code/data/models/antmaze_medium/model.pt'
    ...
    model.train_to_convergence(buffer, debug=True, batch_size=128,
                               ...
                               val_split=0.1, lr_schedule=(1e-4, 1e-3))
    model.cpu()
