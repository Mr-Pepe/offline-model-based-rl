...
python main.py \
    ...
    --agent_lr 3e-4 \
    --use_model True \
    --pretrained_model_path "/home/felipe/Projects/thesis-code/data/models/antmaze_umaze_diverse/model.pt" \
    ...
    --exp_name antmaze_umaze_diverse_inverse_mopo_state_epistemic \
    --datestamp False \
    --log_dir "" \
    --device cuda \
    --render False
